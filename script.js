...
let dificuldadeAtual = 'NIVEL_1'; // NOVO: Controla a dificuldade das perguntas
...
const IMG_BOSS_2_MAT = "https://via.placeholder.com/150/ff5733/FFFFFF?text=BOSS-M2"; // Nova Imagem Boss Mat 2
const IMG_BOSS_2_PORT = "https://via.placeholder.com/150/c0392b/FFFFFF?text=BOSS-P2"; // Nova Imagem Boss Port 2


// --- CONTEÚDO: PERGUNTAS DE MATEMÁTICA ---
const PERGUNTAS_MAT = {
    NIVEL_1: [
        { pergunta: "Quanto é 3 + 1?", respostas: ["1", "3", "4", "2"], correta: "4", inimigo: "Monstro da Adição", inimigoImg: "https://via.placeholder.com/150/e74c3c/FFFFFF?text=Add-1", vida: 1 },
...
function verificarResposta(respostaSelecionada) {
    ...
    if (acertou) {
        ...
        vidaJogador--;
        mensagemElemento.className = 'msg-erro';
        mensagemElemento.textContent = `❌ Ops! O ${perguntaAtual.inimconst IMG_RITMO = "https://via.placeholder.com/150/f0f0f0/FFFFFF?text=Rit-4";
